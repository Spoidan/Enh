...
const navItems = [
  ...
  { href: '/inventory', icon: ShoppingBag, label: 'Inventory' },
  { href: '/sales', icon: BookOpen, label: 'Sales' },
  ...
  return (
    ...
    >
      ...
      <div className={cn('flex items-center gap-3 p-4 border-b border-sidebar-border', collapsed && 'justify-center')}>
        ...
        {!collapsed && (
          <div>
            <p className="font-bold text-sm text-sidebar-foreground leading-none">SchoolAdmin</p>
